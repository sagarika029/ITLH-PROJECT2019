...
<body>
    ...
    <input type="text" class="id" name="name" placeholder="enter product name"
     value="{{ $product->name }}" size="20" required>
<br>
    <label class="id">QUANTITY:-</label>
         <select id = "myList" name="quantity" value="{{ $product->quantity }}" >
...
<div class="city">
    ...
    <label class="id">SIZE:-</label>
      ...
      <select id = "size" name="size" value="{{$product->size}}">
